(function ($) {
	...
	$.fn.shareButtons = function (url, options) {
		...
		var shareURLs = {
			'twitter' : 'https://twitter.com/noemi.honorato/tweet?url=' + url_encoded,
			'facebook' : 'https://www.facebook.com/noemi.honorato.7?url=' + url_encoded,
			'googlePlus' : 'https://plus.google.com/noemi.honorato?url=' + url_encoded,
			'tumblr' : 'http://www.tumblr.com/noemi.honorato/link?url=' + url_encoded,
